...
public class EmployeeService {
	...
	public static List<Employee> readAllEmployees(String fileName) throws EmployeeException  {
		...
		try {
			emps = obj.readValue(file, new TypeReference<List<Employee>>() {});
			 ...
			 throw new EmployeeException("data bind error", e);
		} catch (IOException e) {
			log.warning("could not read the file");
			 throw new EmployeeException("file read error", e);
		}
	...
	public static int saveEmployee(List<Employee> employees) throws EmployeeException {
		String sql ="""
